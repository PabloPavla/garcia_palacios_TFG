            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link as={Link} to="/league"><i className="bi bi-trophy-fill me-1" style={{ color: 'var(--brand-gold)' }}></i> Liga</Nav.Link>
                        <Nav.Link as={Link} to="/league/matches"><i className="bi bi-calendar-event me-1"></i> Jornadas</Nav.Link>
