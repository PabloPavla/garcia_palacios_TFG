...
public interface ClubClient {
    ...
    @org.springframework.web.bind.annotation.GetMapping("/clubs/{id}")
    java.util.Map<String, Object> getClub(@org.springframework.web.bind.annotation.PathVariable("id") Long id);
}
